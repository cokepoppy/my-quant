...
// 更新交易账户
export const updateTradingAccount = async (id: string, data: Partial<TradingAccount>) => {
...
// 获取历史数据
export const getHistoricalData = async (symbol: string, params: {
  startTime: string
  endTime: string
  interval: string
}) => {
...
export default { getTradingAccounts ,getAccountById ,addTradingAccount ,updateTradingAccount ,deleteTradingAccount ,getAccountBalance ,placeOrder ,getOrders ,getOrderById ,cancelOrder ,getPositions ,getPositionById ,closePosition ,getTradeHistory ,getMarketData ,getHistoricalData  }
