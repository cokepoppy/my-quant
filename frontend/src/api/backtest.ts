...
// 导出回测报告
export const exportBacktestReport = async (id: string, format: 'pdf' | 'excel' | 'json') => {
...
export default { runBacktest ,getBacktestResult ,getBacktestJobs ,getBacktestJob ,stopBacktestJob ,deleteBacktestJob ,getBacktestStats ,exportBacktestReport ,getBacktestTemplates ,saveBacktestConfig ,getBacktestConfigs ,deleteBacktestConfig  }
