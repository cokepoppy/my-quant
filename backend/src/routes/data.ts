...
router.post('/test-connection', optionalAuth, async (req: AuthRequest, res) => {
  try {
...
router.post('/sample', optionalAuth, async (req: AuthRequest, res) => {
  try {
...
router.post('/test-api', optionalAuth, async (req: AuthRequest, res) => {
  try {
